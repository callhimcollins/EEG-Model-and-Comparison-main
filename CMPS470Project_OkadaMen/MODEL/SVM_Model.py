...
for channel in channels:
    ...
    #Save Param
    with open(f'Model/Parameters/SVMParam_{channel}.pkl', 'wb') as f: pickle.dump(clf, f)

#Test Using Pre-Trained Model
#-------------------------------------------------------------------------------------------------------------------------------------
 
    #Load PT model
    with open(f'Model/Parameters/SVMParam_{channel}.pkl', 'rb') as f: clf_loaded = pickle.load(f)
